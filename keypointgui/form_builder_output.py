...
class MainFrame ( wx.Frame ):
    ...
    def __init__( self, parent ):
        ...
        self.zoom1_txt.SetFont( wx.Font( 12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
        ...
        self.zoom2_txt.SetFont( wx.Font( 12, wx.FONTFAMILY_DEFAULT, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, wx.EmptyString ) )
    ...
    """
    I'm Commenting this out. It looks like by the time it reaches this code, the buttons no longer exist.
    When I run it with this code in I get an ignored exception for a runtime error <wrapped C/C++ object of type Button has been deleted>
